      ...
      child: Column(
          ...
          children: [
            ...
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                const Text('Follow-Ups Reports', style: TextStyle(color: AppColors.cardDarkBlue, fontWeight: FontWeight.bold, fontSize: 20)),
                Text('Manage your Follow-Ups Reports', style: TextStyle(color: Colors.grey, fontSize: 13)),
                              ...
                              Container(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    _buildHeaderCell('Staff Name', width: 150, isHeader: true),
                                    _buildHeaderCell('Followup For', width: 180, isHeader: true),
                                    _buildHeaderCell('Mobile', width: 120, isHeader: true),
                                    _buildHeaderCell('Email', width: 180, isHeader: true),
                                    _buildHeaderCell('Date', width: 120, isHeader: true),
