...
class CustomerConversionView extends StatelessWidget {
  const CustomerConversionView({super.key});
      ...
      child: Column(
          ...
          children: [
            ...
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                const Text('Customer Conversion', style: TextStyle(color: AppColors.cardDarkBlue, fontWeight: FontWeight.bold, fontSize: 20)),
                const Text('Manage your Customer Conversions', style: TextStyle(color: Colors.grey, fontSize: 13)),
                              ...
                              Container(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    _buildHeaderCell('Lead Name', width: 180, isHeader: true),
                                    _buildHeaderCell('Customer Name', width: 180, isHeader: true),
                                    _buildHeaderCell('Converted Date', width: 120, isHeader: true),
                                    _buildHeaderCell('Status', width: 100, isHeader: true),
                                  ],
                                ),
                              ),
