                    ...
                    children: [
                      IconButton(
                        ...
                        onPressed: () {
                          ...
                          for (
                            int i = 0;
                            i < controller.filteredLeads.length;
                            i++
                          ) {
                  ...
                  children: [
                    ...
                    Container(
                      decoration: const BoxDecoration(
                        color: Color(
                          0xFFF39C12,
                        ), // Lighter golden orange instead of primaryOrange
                  ...
                  children: [
                    ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        bool isFacebook =
                            lead.sourceName?.toLowerCase() == 'facebook';
                        bool isGoogle =
                            lead.sourceName?.toLowerCase() == 'google';
            ...
            children: [
              Expanded(
                child: GestureDetector(
                  ...
                  onTap: () {
                    Get.toNamed(
                      '/lead-details',
                      arguments: {'initialTabIndex': 0, 'leadId': id},
                    );
                  },
                  child: Row(
                    crossAxisAlignment: CrossAxisAlignment.start,
              ...
              PopupMenuButton<String>(
                ...
                onSelected: (String result) {
                  ...
                  Get.toNamed(
                    '/lead-details',
                    arguments: {'initialTabIndex': tabIndex, 'leadId': id},
                  );
                },
                color: Colors.white,
                ...
                children: [
                  ...
                  Expanded(
                    ...
                    child: Row(
                      ...
                      children: [
                        if (hasFacebook ||
                            sourceName.toLowerCase() == 'facebook')
                          const Icon(
                            Icons.facebook,
                            size: 18,
                            color: AppColors.cardDarkBlue,
