          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  const Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('Proposals', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: AppColors.cardDarkBlue)),
                      Text('Manage your Proposals', style: TextStyle(fontSize: 14, color: AppColors.cardDarkBlue, fontWeight: FontWeight.w600)),
                    ],
                  ),
                  Row(
                    children: [
                      IconButton(
                        ...
                        onPressed: () {
                          ...
                          PdfExportHelper.openTablePdfPreview(
                            ...
                            headers: ['Subject', 'Related To', 'Assigne', 'open_till', 'Amount', 'Status'],
                            data: data,
                      ...
                      IconButton(
                        ...
                        onPressed: () {
                          ...
                          ExcelExportHelper.shareTableExcel(
                            ...
                            headers: ['Subject', 'to', 'Assigne', 'Date', 'Expiry Date'],
                            data: data,
              ...
              Obx(() {
                ...
                if (controller.filteredProposals.isEmpty) {
                  return const Center(child: Text('No proposals found.', style: TextStyle(color: Colors.grey)));
                }
          ...
          Row(
            ...
            children: [
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        proposal.subject ?? '',
                        style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 14, color: AppColors.cardDarkBlue),
                      ),
                    ),
                  ],
                ),
              ...
              PopupMenuButton<String>(
                ...
                icon: const Icon(Icons.more_vert, size: 20, color: AppColors.cardDarkBlue),
                color: Colors.white,
                ...
                itemBuilder: (BuildContext context) => <PopupMenuEntry<String>>[
                  ...
                  const PopupMenuItem<String>(
                    ...
                    child: Row(
                      children: [
                        Icon(Icons.edit_outlined, size: 16, color: Colors.teal),
                        SizedBox(width: 8),
            ...
            children: [
              ...
              Expanded(
                ...
                child: Row(
                  ...
                  children: [
                    const Icon(Icons.person_add_alt_1, size: 14, color: AppColors.cardDarkBlue),
                    const SizedBox(width: 6),
                    Flexible(
                      child: Text(
                        proposal.addedByName ?? '',
            ...
            children: [
              Row(
                children: [
                  ...
                  const SizedBox(width: 6),
                  Text(proposal.total ?? '0.00', style: const TextStyle(fontSize: 12, color: AppColors.textDark)),
                ],
              ),
              Row(
                children: [
                  ...
                  const SizedBox(width: 6),
                  Text(proposal.openTill ?? 'N/A', style: const TextStyle(fontSize: 12, color: AppColors.textDark)),
                ],
              ),
              Container(
