...
class LeadDetailsView extends GetView<LeadDetailsController> {
  ...
  String _formatTimelineDate(String? isoString) {
                  ...
                  children: [
                    Expanded(
                      child: _buildProfileDetailRow(
                        ...
                        _formatTimelineDate(profile.dateAdded),
                        '',
                        false,
                      ),
                    ),
                    Expanded(
                      child: _buildProfileDetailRow(
                        ...
                        _formatTimelineDate(profile.dateAssigned),
                        '',
                        false,
                      ),
                    ),
                  ...
                  children: [
                    Expanded(
                      child: _buildProfileDetailRow(
                        ...
                        _formatTimelineDate(profile.lastContact),
                        '',
                        false,
                      ),
                    ),
    ...
    return Obx(() {
      ...
      final filteredNotes = controller.notes.where((note) {
        ...
        return note.description.toLowerCase().contains(query) ||
            note.addedByName.toLowerCase().contains(query);
      }).toList();
  ...
  Widget _buildProposalsTab() {
    return Obx(() {
      ...
      final filteredProposals = controller.proposals.where((prop) {
        ...
        return prop.subject.toLowerCase().contains(query) ||
            prop.proposalTo.toLowerCase().contains(query);
      }).toList();
                          ...
                          Expanded(
                            child: Padding(
                              ...
                              child: Center(
                                child: TextField(
                                  onChanged: (value) =>
                                      controller.proposalsSearch.value = value,
                                  decoration: const InputDecoration(
